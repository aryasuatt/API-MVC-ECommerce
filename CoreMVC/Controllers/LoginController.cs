        ...
        public async Task<IActionResult> UserLogin(UserLoginModel model)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (responseData.Token != null)
                {
                    ...
                    return RedirectToAction("Index", "UserDashboard"); // Assuming a UserDashboard controller exists
                }
            }

            ViewData["ErrorMessage"] = "Login failed. Please check your credentials and try again.";
            return View(model);
        }
